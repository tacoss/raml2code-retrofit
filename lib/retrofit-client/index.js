...
generator.parser = function(data) {
  var arg, d, method, methodParse, methodParsePermuted, model, name, newArgs, notReqArgs, options, parsed, permutations, permuted, reqArgs, resource, schemas, shallowMethod, version, _i, _j, _k, _len, _len1, _len2, _ref;
  parsed = [];
